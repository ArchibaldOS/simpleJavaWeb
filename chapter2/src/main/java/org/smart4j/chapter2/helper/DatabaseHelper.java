...
public final class DatabaseHelper {
    //错误日志
    public static final Logger LOGGER = (Logger) org.slf4j.LoggerFactory.getLogger(DatabaseHelper.class);
    ...
    static {
        ...
        //使用PropsUtil读取config.properties配置文件
     ...
     * 关闭数据库连接
     *
     * 由于使用DBCP 所以无需再建一个closeConnection
     * 系统会自动回收Conn
     *
     * 应该也可以使用conn.close 手动回收
     */
    ...
    public static int executeUpdate(String sql, Object... params){
        ...
        return rows;//返回执行后受影响的行数，也就是更新了多少条记录
    }
